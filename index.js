...
// 31. Store all the title of all the movies in an arrray names"allTitles"
...
// 32. Store all the genres of all the movies in an arrray names"allGenres"
...
// 34. Log the lenght of 'allTitles' , 'allGenres' , allActors'

console.log(allActors.length, allGenres.length, allTitles.length)